            ...
            <div className="flex w-full gap-4 mb-6">
                ...
                <div className="w-full ">
                    <div className="flex items-center justify-between w-full gap-4">
                        <p className="text-[16px] font-semibold">fedya <span className="font-normal text-[#777777] ml-1">9 ч.</span></p>
                        <DropdownMenu>
                    ...
                    <p className=" font-normal text-white text-[16px] w-[97%]">I SET MY ALARMS EXTRA EARLY TO MAKE SURE I HAVE ENOUGH TIME TO LAY IN BED AND BE ANGRY ABOUT HAVING TO WAKE UP</p>
