        ...
        <div className="w-full ">
          <div className="flex items-center justify-between w-full gap-4">
            <p className="text-[16px] font-semibold">
              user <span className="font-normal text-[#777777] ml-1">9 ч.</span>
            </p>
            <DropdownMenu>
              <DropdownMenuTrigger className="cursor-pointer pt-1">
                <BsThreeDots color="#777777" size={20} />
              </DropdownMenuTrigger>
      ...
      <div className="flex w-full gap-4 mb-6">
        ...
        <div className="w-full ">
          ...
          <p className=" font-normal text-white text-[16px] w-[97%]">
            ...
            laboriosam quos molestiae dignissimos vitae.
          </p>
          <div className="flex gap-5 mt-2">
            <div className="flex items-center  animate gap-1 hover:scale-[1.1] cursor-pointer ">
              <IoIosHeartEmpty size={20} color="#a6a6a6" />
      ...
      <div className="flex w-full gap-4 mb-6">
        ...
        <div className="w-full ">
          ...
          <p className=" font-normal text-white text-[16px] w-[97%]">
            ...
            animi, fuga molestias fugiat dolores tempora explicabo quis
            laudantium eum asperiores.
          </p>
          <div className="flex gap-5 mt-2">
            <div className="flex items-center  animate gap-1 hover:scale-[1.1] cursor-pointer ">
              <IoIosHeartEmpty size={20} color="#a6a6a6" />
